# UDENSROZE PARTNERSHIP AGREEMENT
## Founder Equity & Governance Framework

**Document Version:** 1.0
**Date:** January 2026
**Status:** DRAFT - Pending Founder Signatures
**Project:** UDENSROZE Wellness Retreat, Puglia, Italy
...
| Partner | Role | Base Equity | Conditional Equity |
|---------|------|-------------|-------------------|
| **Arturs Zalitis (AZ)** | Business Development & Operations | 2% | +18% (see §3.2) |
| **[Medical Director - JI]** | Clinical Director & Medical Programs | TBD% | TBD |
| **Future Investor(s)** | Capital Partner | 60-80% | Per negotiation |

### 1.2 Entity Structure
- **Legal Form:** Italian SRL (Società a Responsabilità Limitata)
- **Registered Office:** Puglia, Italy (exact location TBD upon property acquisition)
- **Operating Name:** UDENSROZE Wellness Retreat

---

## 2. PROJECT OVERVIEW

### 2.1 Strategic Direction (Updated January 2026)

The project has pivoted from the original €4.5M medical clinic concept to a more focused **Wellness Retreat** model:

| Aspect | Previous (Option 1) | Current (Option 2) |
|--------|--------------------|--------------------|
| Concept | Medical clinic with equipment | Wellness retreat with "Russian bohemian" atmosphere |
| Investment | €4.5M | €3-4M |
| Target | General HNWI | Russian-speaking diaspora (CIS, EU, USA, Israel, Australia) |
| Risk Level | Very High | Moderate |
| Licensing | Full medical license required | Wellness/hospitality license |
| Grant Potential | Limited | Up to 60% of CapEx (Puglia Mini PIA) |

### 2.2 Target Market
- **Primary:** Wealthy Russian-speaking clients seeking psychological recovery and relaxation
- **Demographics:** 35-65 years, €500K+ net worth
- **Geography:** CIS countries, European diaspora, USA, Israel, Australia
- **Value Proposition:** Premium wellness experience with native language service, Italian culture, escape from stress/negative news

### 2.3 Financial Targets
- **Total Investment Required:** €3-4M
- **Phase 1 (Property + Basic Renovation):** €2M
- **Phase 2 (Spa, Marketing, Operations):** €1-2M
- **Potential Grant Reduction:** 50-60% of CapEx (Puglia regional grants)
- **Net Investor Requirement:** ~€1.5-2M after grants
...
| Decision Type | AZ | JI | Investor | Required |
|--------------|-----|-----|----------|----------|
| Day-to-day operations | ✓ | ✓ | - | Either founder |
| Hiring staff (< €50K/yr) | ✓ | ✓ | - | Either founder |
| Hiring executives | ✓ | ✓ | ✓ | Unanimous |
| Budget > €50K | - | ✓ | ✓ | Investor + JI |
| Clinical protocols | - | ✓ | - | JI only |
| Property acquisition | ✓ | ✓ | ✓ | Unanimous |
| New equity issuance | ✓ | ✓ | ✓ | Unanimous |
| Sale of company | ✓ | ✓ | ✓ | Unanimous |
| Debt financing | - | ✓ | ✓ | Investor + JI |

### 5.2 Board Structure
- **Board Size:** 3-5 members
- **Composition:**
  - 1-2 Investor representatives
  - 1 JI (Medical Director)
  - 1 AZ (if 20% equity achieved)
  - 1 Independent (optional)

### 5.3 Reporting Requirements
- Monthly: Operating metrics, cash position
- Quarterly: Full P&L, balance sheet, KPIs
- Annually: Audited financials, strategic review
...
### 6.1 Exit Timeline
- **Lock-up Period:** 3 years (no exits allowed)
- **Exit Window:** Years 4-7
- **Target Exit:** Year 5-7 via strategic sale or investor buyout

### 6.2 Exit Mechanisms
1. **Strategic Sale:** Sale to hospitality group, wellness chain, or PE fund
2. **Investor Buyout:** Investor purchases founder shares at fair market value
3. **Founder Buyout:** Founders purchase investor shares (unlikely given capital constraints)
4. **IPO:** Not anticipated for this project size

### 6.3 Tag-Along / Drag-Along
- **Tag-Along:** Founders can sell proportionally if investor sells
- **Drag-Along:** If 75%+ shareholders agree to sale, all must sell
...
- Next Review: Upon investor term sheet
- Status: DRAFT - Requires founder review and legal counsel
